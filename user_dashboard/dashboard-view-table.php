...
<div class="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="dashboard-update.php"><i class="fas fa-edit"></i></i>Update Details</a></li>
            <li class="active"><a href="dashboard-view-table.php"><i class="fas fa-eye"></i></i>View Tour Table</a></li>
        </ul> 
